  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
      ...
      <Card className="border border-gray-200 shadow-md bg-white">
        <CardHeader className="pb-4 px-4 sm:px-5 pt-4 sm:pt-5 border-b border-gray-100">
          <div className="flex items-center gap-2">
            <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
            <CardTitle className="text-sm sm:text-base font-semibold text-gray-900">Tiempo Promedio</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="px-4 sm:px-5 pt-5 sm:pt-6 pb-5 sm:pb-6">
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="bg-blue-50 rounded-lg p-4 sm:p-5">
              <div className="text-center space-y-1.5">
                <p className="text-xs sm:text-sm text-gray-600 font-medium">Total mensajes</p>
                <p className="text-xl sm:text-2xl font-bold text-gray-900">{fr1?.totalMessages || 0}</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="border border-gray-200 shadow-md bg-white">
        <CardHeader className="pb-4 px-4 sm:px-5 pt-4 sm:pt-5 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-sm sm:text-base font-semibold text-gray-900">Mensajes Respondidos</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="px-4 sm:px-5 pt-5 sm:pt-6 pb-5 sm:pb-6">
          <div className="space-y-5 sm:space-y-6">
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1">En menos de 2 horas</p>
            </div>
      ...
      <Card className="border border-gray-200 shadow-md bg-white">
        <CardHeader className="pb-4 px-4 sm:px-5 pt-4 sm:pt-5 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-sm sm:text-base font-semibold text-gray-900">Resolución por Tipo</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="px-4 sm:px-5 pt-5 sm:pt-6 pb-5 sm:pb-6">
          <div className="space-y-5 sm:space-y-6">
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1">En 1ra interacción</p>
            </div>
      ...
      <Card className="border border-gray-200 shadow-md bg-white">
        <CardHeader className="pb-4 px-4 sm:px-5 pt-4 sm:pt-5 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-sm sm:text-base font-semibold text-gray-900">Distribución de Calificaciones</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="px-4 sm:px-5 pt-5 sm:pt-6 pb-5 sm:pb-6">
          <div className="space-y-5 sm:space-y-6">
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1">Promedio / 5.0</p>
            </div>
            <div style={{ height: '180px' }}>
